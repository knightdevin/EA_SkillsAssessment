...
router.get('/schools', async (req, res) => {
  ...
  let apiUrl = `https://api.data.gov/ed/collegescorecard/v1/schools/?school.operating=1&2015.academics.program_available.assoc_or_bachelors=true&2015.student.size__range=1..&school.degrees_awarded.predominant__range=1..3&school.degrees_awarded.highest__range=2..4&id=240444&api_key=QGngZDMgJWOO3FxP97zN1ZKMwOQd0p4ByEU4xYdX`
...
function getSchoolsFromApi() {
  ...
  var options = {
    method: 'GET',
    url:
      'https://api.data.gov/ed/collegescorecard/v1/schools/?school.operating=1&2015.academics.program_available.assoc_or_bachelors=true&2015.student.size__range=1..&school.degrees_awarded.predominant__range=1..3&school.degrees_awarded.highest__range=2..4&id=240444&api_key=QGngZDMgJWOO3FxP97zN1ZKMwOQd0p4ByEU4xYdX',
    headers: {
      Authorization:
